...
pub const App = struct {
    ...
    pub fn init() !Self {
        ...
        self.window = c.SDL_CreateWindow("Boid Simulation", c.SDL_WINDOWPOS_UNDEFINED, c.SDL_WINDOWPOS_UNDEFINED, config.ScreenWidth, config.ScreenHeight, window_flags) orelse {
